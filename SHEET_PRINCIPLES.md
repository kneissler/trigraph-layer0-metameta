# Sheet File Principles Documentation

## Overview

This document describes the principles, patterns, and architecture found in the `.sheet` files of the Layer-0 MetaMeta system. The system implements a self-describing meta-model with multiple meta-levels, type hierarchies, and relation signatures.
